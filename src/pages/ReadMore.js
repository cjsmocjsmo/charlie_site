...
const IndexPage = () => (
  <Layout>
    ...
    organize all of my MP3s.  After looking around the net for awhile 
    I found

    so I started reading the docs and found out to get Ampache up and running 
    you needed to install Apache, MySql, and PHP on a Linux machine.  As I 
    found out Apache, MySql and PHP couldnt be installed on Windows back in 
    those days so I had to make a decision stay with Windows and forget using
    Ampache or give linux a try.
    </p>
    <p>
      <h3>Ubuntu</h3>
    ...
    this time I was introduced to Python, like any new programer I was having 
